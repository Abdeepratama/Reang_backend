...
<body>
  ...
  <script>
    ...
    // Icon kategori plesir sesuai fitur (contoh)
    const fiturIcons = {
      wisata: '🎒',
      pantai: '🏖️',
      candi: '🏯',
    ...
    function renderMarkers(data) {
      ...
      data.forEach(loc => {
        ...
        popupContent += loc.foto ? `<img src="${loc.foto}" alt="Foto plesir" class="foto-plesir" onerror="this.src='/images/placeholder.png'">` : '';
