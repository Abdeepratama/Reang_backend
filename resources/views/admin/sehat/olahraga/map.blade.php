<!-- resources/views/admin/sehat/olahraga/map.blade.php -->
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Peta Tempat Olahraga</title>
...
<body>
    <div id="mapContainer">
        <div id="overlay">
            <input type="text" id="searchInput" placeholder="Cari tempat olahraga...">
      ...
      `);
            ...
            merged.forEach(loc => {
                ...
                item.onclick = () => {
                    ...
                    const icon = loc.eksternal ? externalIcon : iconMap.olahraga;
