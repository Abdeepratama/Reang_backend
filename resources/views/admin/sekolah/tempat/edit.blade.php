...
<div class="container-fluid px-4">
    <h4 class="mt-4 mb-4">Edit Data Sekolah</h4>

    <form action="{{ route('admin.sekolah.tempat.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-2">
                        ...
                        @else
                        <img id="currentPreview" src="{{ asset('images/default-sekolah.jpg') }}" alt="Default" style="max-width:150px; height:auto; border:1px solid #ddd; padding:4px;">
                        @endif
                    </div>
