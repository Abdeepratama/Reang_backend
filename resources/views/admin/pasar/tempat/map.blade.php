...
<div id="mapContainer">
    <div id="overlay">
        <input type="text" id="searchInput" placeholder="Cari pasar...">
...
<script>
  ...
  function getIconByFitur(fitur) {
    ...
    if (key.includes('pasar') || key.includes('tradisional') || key.includes('modern') || key.includes('toko')) {
      return iconMap.pasar;
    }
