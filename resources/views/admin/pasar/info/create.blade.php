...
@section('title', 'Tambah Info Pasar-Yu')

@section('content')
<div class="container mt-4">
    <h2><i class="bi bi-shop"></i> Tambah Info Pasar</h2>

    <form action="{{ route('admin.pasar.info.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<script>
    // Inisialisasi peta dengan titik awal Indramayu
    ...
    const lokasiIcon = L.divIcon({
        html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="38" height="38" fill="#2A9D8F" stroke="white" stroke-width="2"><path d="M12 2C8 2 5 5 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-4-3-7-7-7z"/><circle cx="12" cy="9" r="2.5" fill="white"/></svg>`,
        className: '',
        iconSize: [38, 38],
        iconAnchor: [19, 38],
        popupAnchor: [0, -38]
    ...
    // Isi manual lat/lng -> update marker
