          ...
          <div class="col-lg-4 order-lg-last">
            <!-- <img src="assets/img/hero-img.png" class="img-fluid animated" alt=""> -->
             <div class="d-flex img-fluid animated">
              <a href="#about" class="btn-get-started">Takon Reang <i class="bi bi-question-circle"></i></a>
              <a href="https://www.youtube.com/embed/1YkkDHue270" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-download"></i><span>Unduh Reang Apps</span></a>
            </div>
          </div>
